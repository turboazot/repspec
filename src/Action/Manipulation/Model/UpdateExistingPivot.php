...
class UpdateExistingPivot extends ModelManipulation {
    ...
    /**
     * UpdateExistingPivot constructor.
     *
    ...
    public function do($model)
    {
        ...
        return $model->{$this->relation}()->updateExistingPivot($this->id, $this->attributes, $this->touch); 
    }
}
